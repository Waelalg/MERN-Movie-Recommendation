...
const commands = [
  {
    ...
    command: 'git clone https://github.com/Waelalg/MERN-Movie-Recommendation.git\ncd MERN-Movie-Recommendation'
  },
  {
      ...
      <Container className="mt-4">
        ...
        <Card className="mb-4" style={{ margin: '0 auto', maxWidth: '800px' }}>
          <Card.Body>
            <Card.Title style={{ textAlign: 'center' }}>Machine Learning</Card.Title>
            <ListGroup variant="flush">
              <ListGroup.Item><code>movie_api/views.py</code>: Python script containing the recommendation logic using Pandas, NumPy, and Scikit-learn.</ListGroup.Item>
              <ListGroup.Item><code>movie_api/config.py</code>: Configuration file containing movie data and similarity matrices.</ListGroup.Item>
            </ListGroup>
          </Card.Body>
        </Card>
